...
from blue_snap_python_sdk.paths.agreements_debit_region_type import post
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAgreementsDebitRegionType(ApiTestMixin, unittest.TestCase):
    """
    AgreementsDebitRegionType unit test stubs
