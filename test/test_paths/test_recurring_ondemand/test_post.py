...
from blue_snap_python_sdk.paths.recurring_ondemand import post
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRecurringOndemand(ApiTestMixin, unittest.TestCase):
    """
    RecurringOndemand unit test stubs
