...
from blue_snap_python_sdk.paths.alt_transactions_resolveorder_idorder_id import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAltTransactionsResolveorderIdorderId(ApiTestMixin, unittest.TestCase):
    """
    AltTransactionsResolveorderIdorderId unit test stubs
