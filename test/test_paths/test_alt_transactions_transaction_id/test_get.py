...
from blue_snap_python_sdk.paths.alt_transactions_transaction_id import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAltTransactionsTransactionId(ApiTestMixin, unittest.TestCase):
    """
    AltTransactionsTransactionId unit test stubs
