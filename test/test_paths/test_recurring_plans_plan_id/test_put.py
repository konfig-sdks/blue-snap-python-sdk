...
from blue_snap_python_sdk.paths.recurring_plans_plan_id import put
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRecurringPlansPlanId(ApiTestMixin, unittest.TestCase):
    """
    RecurringPlansPlanId unit test stubs
        Update Plan
    """
