...
from blue_snap_python_sdk.paths.vaulted_shoppers_vaulted_shopper_id import delete
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestVaultedShoppersVaultedShopperId(ApiTestMixin, unittest.TestCase):
    """
    VaultedShoppersVaultedShopperId unit test stubs
