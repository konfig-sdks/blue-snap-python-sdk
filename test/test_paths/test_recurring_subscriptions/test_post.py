...
from blue_snap_python_sdk.paths.recurring_subscriptions import post
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRecurringSubscriptions(ApiTestMixin, unittest.TestCase):
    """
    RecurringSubscriptions unit test stubs
        Create Subscription
    """
