...
from blue_snap_python_sdk.paths.recurring_ondemand_subscription_id import post
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRecurringOndemandSubscriptionId(ApiTestMixin, unittest.TestCase):
    """
    RecurringOndemandSubscriptionId unit test stubs
