...
from blue_snap_python_sdk.paths.transactions_approval import put
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestTransactionsApproval(ApiTestMixin, unittest.TestCase):
    """
    TransactionsApproval unit test stubs
