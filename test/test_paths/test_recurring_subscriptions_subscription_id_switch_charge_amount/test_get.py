...
from blue_snap_python_sdk.paths.recurring_subscriptions_subscription_id_switch_charge_amount import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestRecurringSubscriptionsSubscriptionIdSwitchChargeAmount(ApiTestMixin, unittest.TestCase):
    """
    RecurringSubscriptionsSubscriptionIdSwitchChargeAmount unit test stubs
