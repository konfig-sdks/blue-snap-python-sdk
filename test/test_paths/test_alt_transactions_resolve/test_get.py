...
from blue_snap_python_sdk.paths.alt_transactions_resolve import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAltTransactionsResolve(ApiTestMixin, unittest.TestCase):
    """
    AltTransactionsResolve unit test stubs
