...
from blue_snap_python_sdk.paths.vendorsparameters import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestVendorsparameters(ApiTestMixin, unittest.TestCase):
    """
    Vendorsparameters unit test stubs
