...
from blue_snap_python_sdk.paths.agreements_prenotification_transaction_id import get
from blue_snap_python_sdk import configuration, schemas, api_client

from .. import ApiTestMixin


class TestAgreementsPrenotificationTransactionId(ApiTestMixin, unittest.TestCase):
    """
    AgreementsPrenotificationTransactionId unit test stubs
