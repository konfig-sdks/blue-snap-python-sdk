...
class TestSubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo(unittest.TestCase):
    """SubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo unit test stubs"""
    pass
