...
class TestShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfo(unittest.TestCase):
    """ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfo unit test stubs"""
    pass
