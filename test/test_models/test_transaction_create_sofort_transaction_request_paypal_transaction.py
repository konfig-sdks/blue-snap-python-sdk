...
class TestTransactionCreateSofortTransactionRequestPaypalTransaction(unittest.TestCase):
    """TransactionCreateSofortTransactionRequestPaypalTransaction unit test stubs"""
    pass
