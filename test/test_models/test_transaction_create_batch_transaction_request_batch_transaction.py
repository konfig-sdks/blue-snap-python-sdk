...
class TestTransactionCreateBatchTransactionRequestBatchTransaction(unittest.TestCase):
    """TransactionCreateBatchTransactionRequestBatchTransaction unit test stubs"""
    pass
