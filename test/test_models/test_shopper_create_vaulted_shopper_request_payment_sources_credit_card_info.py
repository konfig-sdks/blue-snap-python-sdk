...
class TestShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfo(unittest.TestCase):
    """ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfo unit test stubs"""
    pass
