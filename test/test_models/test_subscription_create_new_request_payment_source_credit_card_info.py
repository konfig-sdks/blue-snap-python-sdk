...
class TestSubscriptionCreateNewRequestPaymentSourceCreditCardInfo(unittest.TestCase):
    """SubscriptionCreateNewRequestPaymentSourceCreditCardInfo unit test stubs"""
    pass
