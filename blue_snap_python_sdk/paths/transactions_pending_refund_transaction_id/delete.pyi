...
class BaseApi(api_client.Api):
    ...
    def _cancel_pending_refund_mapped_args(
        self,
        transaction_id: str,
    ...
    async def _acancel_pending_refund_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/transactions/pending-refund/{transactionId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _cancel_pending_refund_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class CancelPendingRefundRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def acancel_pending_refund(
        self,
        transaction_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._cancel_pending_refund_mapped_args(
            transaction_id=transaction_id,
        )
        return await self._acancel_pending_refund_oapg(
    ...
    def cancel_pending_refund(
        ...
        return self._cancel_pending_refund_oapg(
            path_params=args.path,
        )

class CancelPendingRefund(BaseApi):
    ...
    async def acancel_pending_refund(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.acancel_pending_refund(
            transaction_id=transaction_id,
            **kwargs,
        )
    ...
    def cancel_pending_refund(
        ...
        raw_response = self.raw.cancel_pending_refund(
            transaction_id=transaction_id,
        )
