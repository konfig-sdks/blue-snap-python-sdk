...
# Path params
BatchIdSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'batchId': typing.Union[BatchIdSchema, str, ],
    }
)
...
class BaseApi(api_client.Api):
    ...
    def _get_batch_transaction_mapped_args(
        self,
        batch_id: str,
    ...
    async def _aget_batch_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/batch-transactions/{batchId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_batch_transaction_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetBatchTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_batch_transaction(
        self,
        batch_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_batch_transaction_mapped_args(
            batch_id=batch_id,
        )
        return await self._aget_batch_transaction_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_batch_transaction(
        self,
        batch_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_batch_transaction_oapg(
            path_params=args.path,
        )

class GetBatchTransaction(BaseApi):
    ...
    async def aget_batch_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_batch_transaction(
            batch_id=batch_id,
            **kwargs,
        )
    ...
    def get_batch_transaction(
        ...
        raw_response = self.raw.get_batch_transaction(
            batch_id=batch_id,
        )
