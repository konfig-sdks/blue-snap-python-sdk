...
# Query params
AgreementIdSchema = schemas.StrSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'agreementId': typing.Union[AgreementIdSchema, str, ],
    },
    total=False
)
...
request_query_agreement_id = api_client.QueryParameter(
    name="agreementId",
...
class BaseApi(api_client.Api):
    ...
    def _get_debit_mapped_args(
        ...
        if agreement_id is not None:
            _query_params["agreementId"] = agreement_id
        args.query = _query_params
        return args

    async def _aget_debit_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/agreements/{agreementId}',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetDebitRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_debit(
        self,
        agreement_id: typing.Optional[str] = None,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_debit_mapped_args(
            agreement_id=agreement_id,
        )
        return await self._aget_debit_oapg(
    ...
    def get_debit(
        ...
        return self._get_debit_oapg(
            query_params=args.query,
        )

class GetDebit(BaseApi):
    ...
    async def aget_debit(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_debit(
            agreement_id=agreement_id,
            **kwargs,
        )
    ...
    def get_debit(
        ...
        raw_response = self.raw.get_debit(
            agreement_id=agreement_id,
        )
