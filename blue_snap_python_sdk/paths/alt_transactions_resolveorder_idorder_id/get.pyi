...
class BaseApi(api_client.Api):
    ...
    def _get_paypal_transaction_mapped_args(
        self,
        order_id: str,
    ...
    async def _aget_paypal_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/alt-transactions/resolve?orderId={orderId}',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_paypal_transaction_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetPaypalTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_paypal_transaction(
        self,
        order_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_paypal_transaction_mapped_args(
            order_id=order_id,
        )
        return await self._aget_paypal_transaction_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_paypal_transaction(
        self,
        order_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_paypal_transaction_oapg(
            path_params=args.path,
        )

class GetPaypalTransaction(BaseApi):
    ...
    async def aget_paypal_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_paypal_transaction(
            order_id=order_id,
            **kwargs,
        )
    ...
    def get_paypal_transaction(
        ...
        raw_response = self.raw.get_paypal_transaction(
            order_id=order_id,
        )
