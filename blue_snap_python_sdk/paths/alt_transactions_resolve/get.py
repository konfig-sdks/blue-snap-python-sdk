...
# Query params
OrderIdSchema = schemas.Int32Schema
...
class BaseApi(api_client.Api):
    ...
    def _get_sofort_transaction_mapped_args(
        self,
        order_id: int,
        ...
        if order_id is not None:
            _query_params["orderId"] = order_id
        args.query = _query_params
        return args

    async def _aget_sofort_transaction_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/alt-transactions/resolve',
            auth_settings=_auth,
            headers=_headers,
        )
    ...
    def _get_sofort_transaction_oapg(
        self,
            query_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSofortTransactionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_sofort_transaction(
        self,
        order_id: int,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_sofort_transaction_mapped_args(
            order_id=order_id,
        )
        return await self._aget_sofort_transaction_oapg(
            query_params=args.query,
            **kwargs,
        )
    
    def get_sofort_transaction(
        self,
        order_id: int,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_sofort_transaction_oapg(
            query_params=args.query,
        )

class GetSofortTransaction(BaseApi):
    ...
    async def aget_sofort_transaction(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_sofort_transaction(
            order_id=order_id,
            **kwargs,
        )
    ...
    def get_sofort_transaction(
        ...
        raw_response = self.raw.get_sofort_transaction(
            order_id=order_id,
        )
