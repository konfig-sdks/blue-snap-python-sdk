...
from blue_snap_python_sdk.exceptions_base import ApiValueError
from blue_snap_python_sdk.exceptions import ClientConfigurationError
...
conf = blue_snap_python_sdk.Configuration(
...
conf = blue_snap_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://sandbox.bluesnap.com/services/2" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if sec1:
            self.api_key['sec1'] = sec1
        else:
            raise ClientConfigurationError('API Key "sec1" is required')
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("blue_snap_python_sdk")
    ...
    def to_debug_report(self):
        ...
        return "Python SDK Debug Report:\n"\
               ...
               "Version of the API: 8976-Tools\n"\
               "SDK Package Version: 8976-Tools".\
    ...
    def get_host_settings(self):
        ...
        return [
            {
                'url': "https://sandbox.bluesnap.com/services/2",
