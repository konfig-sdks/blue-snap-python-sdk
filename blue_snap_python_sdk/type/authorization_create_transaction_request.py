...
class RequiredAuthorizationCreateTransactionRequest(TypedDict):
    pass

class OptionalAuthorizationCreateTransactionRequest(TypedDict, total=False):
...
class AuthorizationCreateTransactionRequest(RequiredAuthorizationCreateTransactionRequest, OptionalAuthorizationCreateTransactionRequest):
    pass
