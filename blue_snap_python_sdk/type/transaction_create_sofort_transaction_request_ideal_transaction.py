...
class RequiredTransactionCreateSofortTransactionRequestIdealTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestIdealTransaction(TypedDict, total=False):
    returnUrl: str

class TransactionCreateSofortTransactionRequestIdealTransaction(RequiredTransactionCreateSofortTransactionRequestIdealTransaction, OptionalTransactionCreateSofortTransactionRequestIdealTransaction):
    pass
