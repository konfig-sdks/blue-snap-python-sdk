...
class RequiredSubscriptionCreateMerchantManagedChargeRequest(TypedDict):
    pass

class OptionalSubscriptionCreateMerchantManagedChargeRequest(TypedDict, total=False):
...
class SubscriptionCreateMerchantManagedChargeRequest(RequiredSubscriptionCreateMerchantManagedChargeRequest, OptionalSubscriptionCreateMerchantManagedChargeRequest):
    pass
