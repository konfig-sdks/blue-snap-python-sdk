...
class RequiredTransactionCreateBatchTransactionRequest(TypedDict):
    pass

class OptionalTransactionCreateBatchTransactionRequest(TypedDict, total=False):
    batchTransaction: TransactionCreateBatchTransactionRequestBatchTransaction

class TransactionCreateBatchTransactionRequest(RequiredTransactionCreateBatchTransactionRequest, OptionalTransactionCreateBatchTransactionRequest):
    pass
