...
class RequiredTransactionCreateSofortTransactionRequestSepaDirectDebitTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestSepaDirectDebitTransaction(TypedDict, total=False):
    iban: str

class TransactionCreateSofortTransactionRequestSepaDirectDebitTransaction(RequiredTransactionCreateSofortTransactionRequestSepaDirectDebitTransaction, OptionalTransactionCreateSofortTransactionRequestSepaDirectDebitTransaction):
    pass
