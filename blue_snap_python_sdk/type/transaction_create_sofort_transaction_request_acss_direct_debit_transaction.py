...
class RequiredTransactionCreateSofortTransactionRequestAcssDirectDebitTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestAcssDirectDebitTransaction(TypedDict, total=False):
    routingNumber: str
...
class TransactionCreateSofortTransactionRequestAcssDirectDebitTransaction(RequiredTransactionCreateSofortTransactionRequestAcssDirectDebitTransaction, OptionalTransactionCreateSofortTransactionRequestAcssDirectDebitTransaction):
    pass
