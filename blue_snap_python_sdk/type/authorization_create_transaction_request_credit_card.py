...
class RequiredAuthorizationCreateTransactionRequestCreditCard(TypedDict):
    pass

class OptionalAuthorizationCreateTransactionRequestCreditCard(TypedDict, total=False):
    expirationYear: int
...
class AuthorizationCreateTransactionRequestCreditCard(RequiredAuthorizationCreateTransactionRequestCreditCard, OptionalAuthorizationCreateTransactionRequestCreditCard):
    pass
