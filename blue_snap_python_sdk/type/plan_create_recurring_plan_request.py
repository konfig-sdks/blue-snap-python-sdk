...
class RequiredPlanCreateRecurringPlanRequest(TypedDict):
    pass

class OptionalPlanCreateRecurringPlanRequest(TypedDict, total=False):
    chargeFrequency: str
    ...
    recurringChargeAmount: typing.Union[int, float]

    chargeOnPlanSwitch: bool

class PlanCreateRecurringPlanRequest(RequiredPlanCreateRecurringPlanRequest, OptionalPlanCreateRecurringPlanRequest):
    pass
