...
class RequiredSubscriptionCreateNewRequest(TypedDict):
    pass

class OptionalSubscriptionCreateNewRequest(TypedDict, total=False):
...
class SubscriptionCreateNewRequest(RequiredSubscriptionCreateNewRequest, OptionalSubscriptionCreateNewRequest):
    pass
