...
class RequiredTransactionCreateSofortTransactionRequestPayerInfo(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestPayerInfo(TypedDict, total=False):
    zip: str
...
class TransactionCreateSofortTransactionRequestPayerInfo(RequiredTransactionCreateSofortTransactionRequestPayerInfo, OptionalTransactionCreateSofortTransactionRequestPayerInfo):
    pass
