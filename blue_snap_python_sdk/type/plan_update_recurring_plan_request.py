...
class RequiredPlanUpdateRecurringPlanRequest(TypedDict):
    pass

class OptionalPlanUpdateRecurringPlanRequest(TypedDict, total=False):
    chargeFrequency: str
...
class PlanUpdateRecurringPlanRequest(RequiredPlanUpdateRecurringPlanRequest, OptionalPlanUpdateRecurringPlanRequest):
    pass
