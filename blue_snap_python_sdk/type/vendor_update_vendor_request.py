...
class RequiredVendorUpdateVendorRequest(TypedDict):
    pass

class OptionalVendorUpdateVendorRequest(TypedDict, total=False):
    email: str
    ...
    payoutInfo: VendorUpdateVendorRequestPayoutInfo

    vendorAgreement: VendorUpdateVendorRequestVendorAgreement

class VendorUpdateVendorRequest(RequiredVendorUpdateVendorRequest, OptionalVendorUpdateVendorRequest):
    pass
