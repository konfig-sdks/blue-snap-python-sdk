...
class RequiredTransactionCreateSofortTransactionRequestSofortTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestSofortTransaction(TypedDict, total=False):
    returnUrl: str

class TransactionCreateSofortTransactionRequestSofortTransaction(RequiredTransactionCreateSofortTransactionRequestSofortTransaction, OptionalTransactionCreateSofortTransactionRequestSofortTransaction):
    pass
