...
class RequiredVendorUpdateVendorRequestVendorPrincipal(TypedDict):
    pass

class OptionalVendorUpdateVendorRequestVendorPrincipal(TypedDict, total=False):
    firstName: str
...
class VendorUpdateVendorRequestVendorPrincipal(RequiredVendorUpdateVendorRequestVendorPrincipal, OptionalVendorUpdateVendorRequestVendorPrincipal):
    pass
