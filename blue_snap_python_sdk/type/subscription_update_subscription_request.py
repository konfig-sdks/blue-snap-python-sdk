...
class RequiredSubscriptionUpdateSubscriptionRequest(TypedDict):
    pass

class OptionalSubscriptionUpdateSubscriptionRequest(TypedDict, total=False):
    planId: str

class SubscriptionUpdateSubscriptionRequest(RequiredSubscriptionUpdateSubscriptionRequest, OptionalSubscriptionUpdateSubscriptionRequest):
    pass
