...
class RequiredTransactionCreateSofortTransactionRequestBecsDirectDebitTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestBecsDirectDebitTransaction(TypedDict, total=False):
    bsbNumber: str
...
class TransactionCreateSofortTransactionRequestBecsDirectDebitTransaction(RequiredTransactionCreateSofortTransactionRequestBecsDirectDebitTransaction, OptionalTransactionCreateSofortTransactionRequestBecsDirectDebitTransaction):
    pass
