...
class RequiredTransactionUpdatePaypalTransactionRequest(TypedDict):
    pass

class OptionalTransactionUpdatePaypalTransactionRequest(TypedDict, total=False):
...
class TransactionUpdatePaypalTransactionRequest(RequiredTransactionUpdatePaypalTransactionRequest, OptionalTransactionUpdatePaypalTransactionRequest):
    pass
