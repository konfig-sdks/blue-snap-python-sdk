...
class RequiredTransactionCreateSofortTransactionRequestEcpTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestEcpTransaction(TypedDict, total=False):
    routingNumber: str
...
class TransactionCreateSofortTransactionRequestEcpTransaction(RequiredTransactionCreateSofortTransactionRequestEcpTransaction, OptionalTransactionCreateSofortTransactionRequestEcpTransaction):
    pass
