...
class RequiredVendorCreateRequestVendorAgreement(TypedDict):
    pass

class OptionalVendorCreateRequestVendorAgreement(TypedDict, total=False):
    commissionPercent: int

class VendorCreateRequestVendorAgreement(RequiredVendorCreateRequestVendorAgreement, OptionalVendorCreateRequestVendorAgreement):
    pass
