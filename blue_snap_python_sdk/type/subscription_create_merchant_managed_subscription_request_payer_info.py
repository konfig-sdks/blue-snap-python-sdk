...
class RequiredSubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo(TypedDict):
    pass

class OptionalSubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo(TypedDict, total=False):
    firstName: str
...
class SubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo(RequiredSubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo, OptionalSubscriptionCreateMerchantManagedSubscriptionRequestPayerInfo):
    pass
