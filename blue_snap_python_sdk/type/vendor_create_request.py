...
class RequiredVendorCreateRequest(TypedDict):
    pass

class OptionalVendorCreateRequest(TypedDict, total=False):
    email: str
    ...
    payoutInfo: typing.Dict[str, typing.Union[bool, date, datetime, dict, float, int, list, str, None]]

class VendorCreateRequest(RequiredVendorCreateRequest, OptionalVendorCreateRequest):
    pass
