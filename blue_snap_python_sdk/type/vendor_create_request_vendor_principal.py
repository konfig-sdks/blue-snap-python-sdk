...
class RequiredVendorCreateRequestVendorPrincipal(TypedDict):
    pass

class OptionalVendorCreateRequestVendorPrincipal(TypedDict, total=False):
    firstName: str
    ...
    personalIdentificationNumber: str

    driverLicenseNumber: str

    email: str

class VendorCreateRequestVendorPrincipal(RequiredVendorCreateRequestVendorPrincipal, OptionalVendorCreateRequestVendorPrincipal):
    pass
