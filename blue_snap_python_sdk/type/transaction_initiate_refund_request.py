...
class RequiredTransactionInitiateRefundRequest(TypedDict):
    pass

class OptionalTransactionInitiateRefundRequest(TypedDict, total=False):
    reason: str
...
class TransactionInitiateRefundRequest(RequiredTransactionInitiateRefundRequest, OptionalTransactionInitiateRefundRequest):
    pass
