...
class RequiredVendorUpdateVendorRequestVendorAgreement(TypedDict):
    pass

class OptionalVendorUpdateVendorRequestVendorAgreement(TypedDict, total=False):
    commissionPercent: int

    accountStatus: str

class VendorUpdateVendorRequestVendorAgreement(RequiredVendorUpdateVendorRequestVendorAgreement, OptionalVendorUpdateVendorRequestVendorAgreement):
    pass
