...
class RequiredVendorUpdateVendorRequestPayoutInfoItem(TypedDict):
    pass

class OptionalVendorUpdateVendorRequestPayoutInfoItem(TypedDict, total=False):
    payoutType: str
...
class VendorUpdateVendorRequestPayoutInfoItem(RequiredVendorUpdateVendorRequestPayoutInfoItem, OptionalVendorUpdateVendorRequestPayoutInfoItem):
    pass
