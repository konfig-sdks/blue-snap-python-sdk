...
class RequiredTransactionUpdatePaypalTransactionRequestPaypalTransaction(TypedDict):
    pass

class OptionalTransactionUpdatePaypalTransactionRequestPaypalTransaction(TypedDict, total=False):
    orderId: str

    transactionType: str

class TransactionUpdatePaypalTransactionRequestPaypalTransaction(RequiredTransactionUpdatePaypalTransactionRequestPaypalTransaction, OptionalTransactionUpdatePaypalTransactionRequestPaypalTransaction):
    pass
