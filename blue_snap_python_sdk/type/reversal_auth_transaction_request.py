...
class RequiredReversalAuthTransactionRequest(TypedDict):
    pass

class OptionalReversalAuthTransactionRequest(TypedDict, total=False):
    cardTransactionType: str

    transactionId: int

class ReversalAuthTransactionRequest(RequiredReversalAuthTransactionRequest, OptionalReversalAuthTransactionRequest):
    pass
