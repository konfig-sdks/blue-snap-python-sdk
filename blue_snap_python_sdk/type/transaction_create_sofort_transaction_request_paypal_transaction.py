...
class RequiredTransactionCreateSofortTransactionRequestPaypalTransaction(TypedDict):
    pass

class OptionalTransactionCreateSofortTransactionRequestPaypalTransaction(TypedDict, total=False):
    cancelUrl: str
...
class TransactionCreateSofortTransactionRequestPaypalTransaction(RequiredTransactionCreateSofortTransactionRequestPaypalTransaction, OptionalTransactionCreateSofortTransactionRequestPaypalTransaction):
    pass
