...
class RequiredSubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard(TypedDict):
    pass

class OptionalSubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard(TypedDict, total=False):
    expirationYear: int
...
class SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard(RequiredSubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard, OptionalSubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard):
    pass
