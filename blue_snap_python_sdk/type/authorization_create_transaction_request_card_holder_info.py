...
class RequiredAuthorizationCreateTransactionRequestCardHolderInfo(TypedDict):
    pass

class OptionalAuthorizationCreateTransactionRequestCardHolderInfo(TypedDict, total=False):
    firstName: str
...
class AuthorizationCreateTransactionRequestCardHolderInfo(RequiredAuthorizationCreateTransactionRequestCardHolderInfo, OptionalAuthorizationCreateTransactionRequestCardHolderInfo):
    pass
