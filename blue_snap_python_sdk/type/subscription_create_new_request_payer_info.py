...
class RequiredSubscriptionCreateNewRequestPayerInfo(TypedDict):
    pass

class OptionalSubscriptionCreateNewRequestPayerInfo(TypedDict, total=False):
    zip: str
...
class SubscriptionCreateNewRequestPayerInfo(RequiredSubscriptionCreateNewRequestPayerInfo, OptionalSubscriptionCreateNewRequestPayerInfo):
    pass
