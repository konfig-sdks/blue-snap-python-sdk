...
class TransactionCreateBatchTransactionRequestBatchTransaction(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def cardTransaction() -> typing.Type['TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction']:
                return TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction
            __annotations__ = {
                "batchId": batchId,
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["cardTransaction"]) -> 'TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction': ...
    
    @typing.overload
    def __getitem__(self, name: str) -> schemas.UnsetAnyTypeSchema: ...
    
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["batchId", "callbackUrl", "cardTransaction", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["cardTransaction"]) -> typing.Union['TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["batchId", "callbackUrl", "cardTransaction", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        cardTransaction: typing.Union['TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction', schemas.Unset] = schemas.unset,
