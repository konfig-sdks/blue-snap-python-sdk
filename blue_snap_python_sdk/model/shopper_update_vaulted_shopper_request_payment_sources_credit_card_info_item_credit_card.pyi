...
class ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard':
