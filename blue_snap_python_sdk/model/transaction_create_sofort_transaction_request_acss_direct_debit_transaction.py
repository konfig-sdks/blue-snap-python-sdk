...
class TransactionCreateSofortTransactionRequestAcssDirectDebitTransaction(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["routingNumber", "accountNumber", "accountType", "agreementId", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["routingNumber", "accountNumber", "accountType", "agreementId", ], str]):
