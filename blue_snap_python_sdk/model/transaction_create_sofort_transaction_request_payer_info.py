...
class TransactionCreateSofortTransactionRequestPayerInfo(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["zip", "firstName", "lastName", "phone", "country", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["zip", "firstName", "lastName", "phone", "country", ], str]):
