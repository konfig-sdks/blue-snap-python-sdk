...
class ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard(
    schemas.DictSchema
):
    """
    ...
    ) -> 'ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard':
