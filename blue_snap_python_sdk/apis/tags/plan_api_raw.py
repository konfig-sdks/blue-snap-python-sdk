...
from blue_snap_python_sdk.paths.recurring_plans.post import CreateRecurringPlanRaw
from blue_snap_python_sdk.paths.recurring_plansparameters.get import GetAllRaw
from blue_snap_python_sdk.paths.recurring_plans_plan_id.get import GetSpecificRaw
from blue_snap_python_sdk.paths.recurring_plans_plan_id.put import UpdateRecurringPlanRaw


class PlanApiRaw(
    CreateRecurringPlanRaw,
    GetAllRaw,
    GetSpecificRaw,
    UpdateRecurringPlanRaw,
):
    """NOTE:
