...
from blue_snap_python_sdk.paths.agreements_debit_region_type.post import CreateDebitForAusCanRaw
from blue_snap_python_sdk.paths.agreements_agreement_id.get import GetDebitRaw


class AgreementApiRaw(
    CreateDebitForAusCanRaw,
    GetDebitRaw,
):
    """NOTE:
