...
from blue_snap_python_sdk.pydantic.subscription_create_new_request_payment_source_credit_card_info_credit_card import SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard

class SubscriptionCreateNewRequestPaymentSourceCreditCardInfo(BaseModel):
    credit_card: typing.Optional[SubscriptionCreateNewRequestPaymentSourceCreditCardInfoCreditCard] = Field(None, alias='creditCard')
