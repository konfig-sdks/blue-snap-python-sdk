...
from blue_snap_python_sdk.pydantic.shopper_create_vaulted_shopper_request_payment_sources import ShopperCreateVaultedShopperRequestPaymentSources

class ShopperCreateVaultedShopperRequest(BaseModel):
    payment_sources: typing.Optional[ShopperCreateVaultedShopperRequestPaymentSources] = Field(None, alias='paymentSources')
