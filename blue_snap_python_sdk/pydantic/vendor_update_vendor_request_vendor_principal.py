...
class VendorUpdateVendorRequestVendorPrincipal(BaseModel):
    ...
    personal_identification_number: typing.Optional[int] = Field(None, alias='personalIdentificationNumber')
