...
from blue_snap_python_sdk.pydantic.shopper_update_vaulted_shopper_request_payment_sources_credit_card_info import ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfo

class ShopperUpdateVaultedShopperRequestPaymentSources(BaseModel):
    credit_card_info: typing.Optional[ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfo] = Field(None, alias='creditCardInfo')
