...
class VendorUpdateVendorRequestVendorAgreement(BaseModel):
    commission_percent: typing.Optional[int] = Field(None, alias='commissionPercent')

    account_status: typing.Optional[str] = Field(None, alias='accountStatus')
