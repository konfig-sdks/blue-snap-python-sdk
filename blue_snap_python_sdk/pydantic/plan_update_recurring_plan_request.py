...
class PlanUpdateRecurringPlanRequest(BaseModel):
    charge_frequency: typing.Optional[str] = Field(None, alias='chargeFrequency')

    trial_period_days: typing.Optional[str] = Field(None, alias='trialPeriodDays')

    initial_charge_amount: typing.Optional[str] = Field(None, alias='initialChargeAmount')

    name: typing.Optional[str] = Field(None, alias='name')

    currency: typing.Optional[str] = Field(None, alias='currency')

    recurring_charge_amount: typing.Optional[str] = Field(None, alias='recurringChargeAmount')
