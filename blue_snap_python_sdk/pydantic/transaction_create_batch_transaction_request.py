...
from blue_snap_python_sdk.pydantic.transaction_create_batch_transaction_request_batch_transaction import TransactionCreateBatchTransactionRequestBatchTransaction

class TransactionCreateBatchTransactionRequest(BaseModel):
    batch_transaction: typing.Optional[TransactionCreateBatchTransactionRequestBatchTransaction] = Field(None, alias='batchTransaction')
