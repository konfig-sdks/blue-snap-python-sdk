...
from blue_snap_python_sdk.pydantic.transaction_update_paypal_transaction_request_paypal_transaction import TransactionUpdatePaypalTransactionRequestPaypalTransaction

class TransactionUpdatePaypalTransactionRequest(BaseModel):
    ...
    paypal_transaction: typing.Optional[TransactionUpdatePaypalTransactionRequestPaypalTransaction] = Field(None, alias='paypalTransaction')
