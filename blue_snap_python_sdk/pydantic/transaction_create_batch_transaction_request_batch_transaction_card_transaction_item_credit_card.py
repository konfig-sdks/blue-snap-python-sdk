...
class TransactionCreateBatchTransactionRequestBatchTransactionCardTransactionItemCreditCard(BaseModel):
    card_number: typing.Optional[str] = Field(None, alias='cardNumber')

    expiration_month: typing.Optional[str] = Field(None, alias='expirationMonth')

    expiration_year: typing.Optional[str] = Field(None, alias='expirationYear')
