...
from blue_snap_python_sdk.pydantic.transaction_initiate_refund_request_transaction_meta_data import TransactionInitiateRefundRequestTransactionMetaData

class TransactionInitiateRefundRequest(BaseModel):
    reason: typing.Optional[str] = Field(None, alias='reason')

    cancel_subscriptions: typing.Optional[bool] = Field(None, alias='cancelSubscriptions')

    transaction_meta_data: typing.Optional[TransactionInitiateRefundRequestTransactionMetaData] = Field(None, alias='transactionMetaData')
