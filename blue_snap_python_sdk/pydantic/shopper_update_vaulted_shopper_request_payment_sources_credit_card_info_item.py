...
from blue_snap_python_sdk.pydantic.shopper_update_vaulted_shopper_request_payment_sources_credit_card_info_item_credit_card import ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard

class ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoItem(BaseModel):
    credit_card: typing.Optional[ShopperUpdateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard] = Field(None, alias='creditCard')
