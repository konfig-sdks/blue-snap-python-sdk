...
from blue_snap_python_sdk.pydantic.shopper_create_vaulted_shopper_request_payment_sources_credit_card_info import ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfo

class ShopperCreateVaultedShopperRequestPaymentSources(BaseModel):
    credit_card_info: typing.Optional[ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfo] = Field(None, alias='creditCardInfo')
