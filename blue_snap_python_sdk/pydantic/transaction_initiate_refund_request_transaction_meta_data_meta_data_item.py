...
class TransactionInitiateRefundRequestTransactionMetaDataMetaDataItem(BaseModel):
    meta_value: typing.Optional[str] = Field(None, alias='metaValue')

    meta_key: typing.Optional[str] = Field(None, alias='metaKey')

    meta_description: typing.Optional[str] = Field(None, alias='metaDescription')
