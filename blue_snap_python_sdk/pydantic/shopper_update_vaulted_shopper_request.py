...
from blue_snap_python_sdk.pydantic.shopper_update_vaulted_shopper_request_payment_sources import ShopperUpdateVaultedShopperRequestPaymentSources

class ShopperUpdateVaultedShopperRequest(BaseModel):
    payment_sources: typing.Optional[ShopperUpdateVaultedShopperRequestPaymentSources] = Field(None, alias='paymentSources')
