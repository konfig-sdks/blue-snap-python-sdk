...
from blue_snap_python_sdk.pydantic.transaction_create_batch_transaction_request_batch_transaction_card_transaction import TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction

class TransactionCreateBatchTransactionRequestBatchTransaction(BaseModel):
    batch_id: typing.Optional[str] = Field(None, alias='batchId')

    callback_url: typing.Optional[str] = Field(None, alias='callbackUrl')

    card_transaction: typing.Optional[TransactionCreateBatchTransactionRequestBatchTransactionCardTransaction] = Field(None, alias='cardTransaction')
