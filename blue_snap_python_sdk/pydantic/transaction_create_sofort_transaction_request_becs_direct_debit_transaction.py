...
class TransactionCreateSofortTransactionRequestBecsDirectDebitTransaction(BaseModel):
    bsb_number: typing.Optional[str] = Field(None, alias='bsbNumber')
    ...
    financial_institution: typing.Optional[str] = Field(None, alias='financialInstitution')

    branch_name: typing.Optional[str] = Field(None, alias='branchName')

    agreement_id: typing.Optional[int] = Field(None, alias='agreementId')
