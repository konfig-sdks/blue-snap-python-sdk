...
from blue_snap_python_sdk.pydantic.transaction_initiate_refund_request_transaction_meta_data_meta_data import TransactionInitiateRefundRequestTransactionMetaDataMetaData

class TransactionInitiateRefundRequestTransactionMetaData(BaseModel):
    meta_data: typing.Optional[TransactionInitiateRefundRequestTransactionMetaDataMetaData] = Field(None, alias='metaData')
