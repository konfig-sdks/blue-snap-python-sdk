...
from blue_snap_python_sdk.pydantic.subscription_create_new_request_payment_source_credit_card_info import SubscriptionCreateNewRequestPaymentSourceCreditCardInfo

class SubscriptionCreateNewRequestPaymentSource(BaseModel):
    credit_card_info: typing.Optional[SubscriptionCreateNewRequestPaymentSourceCreditCardInfo] = Field(None, alias='creditCardInfo')
