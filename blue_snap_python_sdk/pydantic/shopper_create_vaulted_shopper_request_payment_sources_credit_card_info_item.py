...
from blue_snap_python_sdk.pydantic.shopper_create_vaulted_shopper_request_payment_sources_credit_card_info_item_credit_card import ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard

class ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoItem(BaseModel):
    credit_card: typing.Optional[ShopperCreateVaultedShopperRequestPaymentSourcesCreditCardInfoItemCreditCard] = Field(None, alias='creditCard')
